...
url = 'https://hacprd.fultonschools.org/HomeAccess/Content/Student/Assignments.aspx'
login_url = 'https://hacprd.fultonschools.org/HomeAccess/Account/LogOn?ReturnUrl=%2fhomeaccess'
print('RUNNING')
...
def student():
    ...
    if 'name' not in session:
        url2 = 'https://hacprd.fultonschools.org/HomeAccess/Classes/Classwork'
...
def info(cont, z, cls):
    ...
    # print("n_in_info", z)
    if not err:
        # print("while not err in info (44)")
        data = []
        de = {}
...
def average(content):
    ...
    try:
        ...
        if grd is True:
            # print("grade in average (74)", grade)
            return grade
    except IndexError:
        # print("index error in average (88)")
        err = True
        pass
...
def points(cont, z, cls):
    ...
    # print(z)
    while not err:
        # print("while not err in points (111")
        v = []
        soup = BeautifulSoup(cont, "lxml")
...
def login():
	...
	try:
		...
		return redirect(url_for('index', messages=str(e)))
...
def dashboard():
    ...
    return render_template("dashboard.html", value=ge, name=nme)
